...
The public code and retained numerical evidence are distributed as
\href{https://github.com/ElvisCuiHan/randomized-ks-calibration/releases/tag/v1.0.0}{release v1.0.0}
of the \href{https://github.com/ElvisCuiHan/randomized-ks-calibration}{companion repository}.
The release includes the clean manuscript, this supplement, and a per-file
